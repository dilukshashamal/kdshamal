...
export function About() {
  ...
  const experience = [
    {
      ...
      description: 'Leading AI initiatives and developing state-of-the-art ML models',
    },
    {
      period: '2020 - 2022',
  ...
  return (
    <section id="about" className="relative py-20 bg-gradient-to-b from-black to-blue-950/10">
