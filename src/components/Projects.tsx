...
export function Projects() {
  const projects = [
    {
      ...
      description:
        "Real-time data analysis using advanced machine learning algorithms for predictive insights.",
    ...
    },
    {
      ...
      description:
        "Object detection and recognition system for automated quality control in manufacturing.",
    ...
    },
    {
      ...
      description:
        "Intelligent conversational AI with context awareness and multi-language support.",
    ...
    },
    {
      ...
      description:
        "Automated ML model training, deployment, and monitoring infrastructure.",
    ...
    },
    {
      ...
      description:
        "Personalized content recommendation system using collaborative filtering and deep learning.",
    ...
    },
    {
      ...
      description:
        "Reinforcement learning environment for training autonomous agents in complex scenarios.",
  ...
  return (
    <section
      id="projects"
      className="relative py-20 bg-gradient-to-b from-purple-950/10 to-black"
    >
