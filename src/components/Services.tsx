...
export function Services() {
  const services = [
    {
      ...
      description:
        "Custom machine learning models tailored to your business needs, from computer vision to NLP solutions.",
      features: [
        "Custom ML Models",
    ...
    },
    {
      ...
      description:
        "Advanced neural network architectures for complex problems requiring state-of-the-art AI capabilities.",
    ...
    },
    {
      ...
      description:
        "Build robust data pipelines and infrastructure to support your AI and analytics initiatives.",
    ...
    },
    {
      ...
      description:
        "End-to-end ML pipeline automation, monitoring, and scaling for production environments.",
    ...
    },
    {
      ...
      description:
        "Complete web and mobile applications with modern frameworks and best practices.",
    ...
    },
    {
      ...
      title: "AI Consulting",
      description:
        "Strategic guidance on AI adoption, technology selection, and implementation roadmaps.",
  ...
  return (
    <section
      id="services"
      className="relative py-20 bg-gradient-to-b from-blue-950/10 to-purple-950/10"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-3xl mx-auto">
            Comprehensive AI and software engineering services to transform your
            vision into reality
          </p>
        </motion.div>
